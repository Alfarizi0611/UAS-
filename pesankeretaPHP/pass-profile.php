            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="user-info-list card">
                  <div class="card-header card-header-divider">Tentang Saya<span class="card-subtitle"><?php echo $row->pass_bio;?></span></div>
                  <div class="card-body">
                    <table class="no-border no-strip skills">
                      <tbody class="no-border-x no-border-y">
                        <tr>
                          <td class="icon"><span class="mdi mdi-cake"></span></td>
                          <td class="item">Ulang Tahun<span class="icon s7-gift"></span></td>
                          <td><?php echo $row->pass_bday;?></td>
                        </tr>
                        <tr>
                          <td class="icon"><span class="mdi mdi-smartphone-android"></span></td>
                          <td class="item">Telp<span class="icon s7-phone"></span></td>
