      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-danger">
            <div class="card-header"><img class="logo-img" src="assets/img/Logoni 1.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Admin Login Panel</span></div>
            <div class="card-body">
          ...
          <div class="splash-footer">&copy; 2020 - <?php echo date('Y'); ?> Pemesanan Tiket Kereta Online | Developed By Alfarizi</div>
        </div>
      </div>
    </div>
  </div>
