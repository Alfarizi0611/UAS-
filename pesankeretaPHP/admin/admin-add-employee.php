  ...
  <body>
	...
	<!--Log on to codeastro.com for more projects!-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Tambah Karyawan</h2>
          ...
          <div class="row">
			...
			<!--Log on to codeastro.com for more projects!-->
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Buat Profile Karyawan<span class="card-subtitle">Tuliskan data dengan lengkap</span></div>
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">ID unik</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="emp_nat_idno"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Kontak</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Tempat sekrang</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Tambah Karyawan " name = "Create_Profile" type="submit">
