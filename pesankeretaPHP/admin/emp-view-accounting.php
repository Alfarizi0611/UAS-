            ...
            <div class="col-12 col-lg-6 col-xl-6">
              ...
              <div class="chart sparkline"><i class="material-icons">attach_money</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                  ?>
                  <div class="desc">Tiket Dibayar</div>
                  <div class="value">Rp<span class="number" data-toggle="counter" data-end="<?php echo $count_fare;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-6">
              ...
              <div class="chart sparkline"><i class="material-icons">assignment_late</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                  <div class="desc">Checkout Tertunda</div>
              ...
              <div class="chart sparkline"><i class="material-icons">loyalty</i></div>
                <div class="data-info">
                  <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="desc">Tiket Diterima</div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Status Pembayaran Tiket
                    ...
                    var options = {
                      ...
                      data: [{
                          ...
                          ?>
                            ...
                            { label: "Pembayaran Reservasi", y: <?php echo $approved;?> },
                            { label: "Pembayaran Tertunda", y: <?php echo $not_approved;?> },
