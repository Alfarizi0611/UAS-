  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Lihat Karyawan</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Profile Karyawan<span class="card-subtitle">Tulisakan Data lengkap</span></div>
                <div class="card-body">
                  <form method ="POST">
				  <!--Log on to codeastro.com for more projects!-->
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nomor Telepon</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Tempat Sekerang</label>
                      <div class="col-12 col-sm-8 col-lg-6">
