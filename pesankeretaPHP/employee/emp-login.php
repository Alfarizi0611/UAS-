      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-success">
            <div class="card-header"><img class="logo-img" src="assets/img/Logoni 1.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
              ...
              <form method="POST">
                <div class="login-form ">
                  ...
                  <div class="form-group row login-submit">
                    ...
                    <div class="col-6"><a class="btn btn-danger btn-xl" href="admin-add-employee.php">Register</a></div>
                  </div>
          ...
          <div class="splash-footer">&copy; 2019 - <?php echo date('Y'); ?> Pemesanan Tiket Kereta Online | Developed By Alfarizi</div>
        </div>
      </div>
    </div>
  </div>
