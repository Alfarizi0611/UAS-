              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->emp_uname;?>'s Profile</span></a>
                    <ul class="sub-menu">
                      <li><a href="emp-profile.php">Lihat</a>
                      </li>
                      ...
                      <li><a href="emp-profile-password.php">Ganti Password</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Penumpang</span></a>
                    <ul class="sub-menu">
