...
?>
    <nav class="navbar navbar-expand fixed-top be-top-header">
        ...
        <div class="card-header"><img class="logo-img" src="assets/img/Logoni 1.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description"></span></a>
          </div>
          ...
          $welcome_string="Good Sore!"; 
          else if($numeric_date>=18&&$numeric_date<=23) 
          $welcome_string="Good Malam!"; 
          echo "$welcome_string"; 
          ?>
