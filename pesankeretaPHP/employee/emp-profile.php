            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="user-info-list card">
                  <div class="card-header card-header-divider">Tentang Saya</div>
                  <div class="card-body">
                    <table class="no-border no-strip skills">
                      <tbody class="no-border-x no-border-y">
                        <tr>
                          <td class="icon"><span class="mdi mdi-smartphone-android"></span></td>
                          <td class="item">Telepon<span class="icon s7-phone"></span></td>
                          <td><?php echo $row->emp_phone;?></td>
                        </tr> 
                        <tr>
                          <td class="icon"><span class="mdi mdi mdi-train"></span></td>
                          <td class="item">Tempat Sekarang <span class="icon s7-phone"></span></td>
