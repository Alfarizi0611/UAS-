  ...
  <body>
	...
	<!--Log on to codeastro.com for more projects!-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Kelola Tiket Pemsanan Yang Disetujui </h2>
                ...
                <div class="card-body">
                  <form method ="POST">
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nama Penumpang</label>
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">No pemesanan Tiket</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="train_no"  value="<?php echo $row->train_no?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nama Pemesanan tiket</label>
                      <div class="col-12 col-sm-8 col-lg-6">
