 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Pesan Kereta</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Pesan Kereta</a></li>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Pesan Kereta Pilihanmu               
                </div>
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">
                        <a href="pass-book-specific-train.php?id=<?php echo $row->id?>"><button class="btn btn-success btn-sm">Pesan</button></a>
                        </td>
                      </tr>
                        <?php }?>
                    </tbody>
