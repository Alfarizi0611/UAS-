              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-profile.php">Lihat</a>
                      </li>
                      ...
                      <li><a href="pass-profile-password.php">Ganti Password</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Kereta</span></a>
                    ...
                    <ul class="sub-menu">
                       <li><a href="pass-all-available-trains.php">List Kereta</a>
                       <li><a href="pass-search-available-trains.php">Cari Kereta</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Pesan Kereta</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Simpan Kereta</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Batalkan </a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-ticket-confirmation"></i><span>Tickets</span></a>
                    ...
                    <li><a href="pass-train-checkout-ticket.php">Checkout</a>
                      ...
                      <li><a href="pass-confirm-ticket.php">Setujui Pembayaran</a>
                      </li>
