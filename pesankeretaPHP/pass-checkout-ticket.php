  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Pesan Tiket Kereta </h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider"><span class="card-subtitle">Tulisakan Detailnya</span></div>
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Telepon</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly value="<?php echo $row->pass_phone;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Alamat</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_addr;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">No id Pesanan</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_train_number;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nama kereta Pesanan</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Kode Pembayaran</label>
                      <div class="col-12 col-sm-8 col-lg-6">
